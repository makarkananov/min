...
func (_m *AuthService) ChangeLinksRemaining(ctx context.Context, username string, linksRemaining int64) error {
...
func (_m *AuthService) Register(ctx context.Context, newUser *domain.User) error {
